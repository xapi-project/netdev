...
(* OASIS_START *)
(* DO NOT EDIT (digest: dcf21105e4d8670a317fc46e57fa94b7) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["various"];
          homepage = None;
          synopsis = "Network device misc bindings";
          description = None;
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\209\173\221j\201\247\182%\222\243e\175\238Z\220e";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
